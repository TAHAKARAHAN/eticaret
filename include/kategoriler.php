				            ...
				            <div class="collapse show" id="filter_1">
				                <ul>
				                	...
				                	if($menukategori!=false) {
				                		$kategorisayisi = count($menukategori);
				                		for ($e=0; $e <$kategorisayisi; $e++) {
				                			...
				                			// İlk 10 kategori her zaman gösterilir
				                			$gizleme_class = ($e >= 10) ? 'style="display:none" class="ekstra-kategori"' : '';
				                			?>
				                			<li <?=$gizleme_class?>>
				                        ...
				                        // Eğer 10'dan fazla kategori varsa "Daha Fazla" butonu göster
				                        if($kategorisayisi > 10) {
				                        	?>
				                        	<li class="show-more-btn">
				                        		<a href="javascript:void(0)" onclick="toggleExtraCategories()">
				                        			<label class="container_check daha-fazla">Daha Fazla Göster</label>
				                        		</a>
				                        	</li>
				                        	<?php
				                        }
...
function toggleExtraCategories() {
    var extraItems = document.getElementsByClassName('ekstra-kategori');
    var showMoreBtn = document.querySelector('.daha-fazla');
    
    if (!expanded) {
        for(var i=0; i<extraItems.length; i++) {
            extraItems[i].style.display = 'block';
        }
        ...
        showMoreBtn.innerHTML = 'Daha Fazla Göster';
        expanded = false;
    }
}
</script>